        ...
        <?php if(isset($results)) 
                {
				 ...
				 <?php if($row['image']=="")
    					...
    					<div class="col-md-4">
    						<div class="blog-card card mb-2">
            					<a href="/en/post/why-you-need-efficient-ac-services"><img src="<?php echo $path; ?>" width="100" height="100"></a>
            				</div>
            				<div class="card-block mobile-center">
            					<h5 class="card-title">
		                        <?php echo isset($row['title']) ? $row['title'] : ''; ?></h5>
		                        <p class="card-text"><?php echo isset($row['description']) ? substr($row['description'],0,500) : ''; ?></p>
		                        <a class="btn btn-primary" href="<?php echo site_url('blog/'.$row['id']);?>">Read More</a></a>
		                    </div>
            			</div>
    		<?php  	}
    			}?> 
